	...
	<div class="pcoded-inner-navbar main-menu">
		<div class="">
			<div class="main-menu-header">
				<img class="img-80 img-radius" src="assets/images/foto.jpg"
					alt="User-Profile-Image">
				<div class="user-details">
					<span id="more-details">Cesar Montaldi<i class="fa fa-caret-down"></i></span>
				</div>
			</div>
			...
			<div class="main-menu-content">
				<ul>
					<li class="more-details"><a href="user-profile.html"><i
						...
						href="ServletLogin?acao=logout"><i class="ti-layout-sidebar-left"></i>Logout</a></li>
				</ul>
			</div>
		</div>
